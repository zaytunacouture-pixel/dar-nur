...
-- ('fournisseur-a', ...), et l'unicité porte sur (supplier, product_id, variant_id)
-- — un même produit pourra donc avoir plusieurs fournisseurs plus tard sans
-- changer le schéma. Aucune colonne propre à un fournisseur n'est ajoutée à `products` :
...
create table if not exists public.product_sources (
  ...
  supplier               text not null,                 -- code fournisseur, ex. 'fournisseur-a'
